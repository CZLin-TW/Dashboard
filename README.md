...
| 檔案 | 說明 |
|------|------|
| types.ts | 整套 domain 型別 + helper：DeviceData / DeviceOptions / AcPendingState / TodoData / FoodData / DehumidifierAutoRule / acPendingFromDevice / daysUntilExpiry / todoUrgency / foodUrgency / urgencyRowClass / relativeDateLabel / expiryLabel / DEVICE_ICONS |
