        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {controllableDevices.map((device) => {
            ...
            {isExpanded && (() => {
              ...
              return (
              <div className="col-span-2 sm:col-span-4 rounded-lg border border-gray-700 bg-gray-800/30 p-4 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-gray-200">{deviceIcons[device.type]} {device.name}{device.location && <span className="ml-2 text-xs font-normal text-gray-500">{device.location}</span>}</h3>
